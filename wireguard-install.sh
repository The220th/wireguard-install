...
#   https://github.com/The220th/wireguard-install forked from 
...
function installQuestions() {
	...
	echo "https://github.com/The220th/wireguard-install"
	echo "               forked from https://github.com/angristan/wireguard-install"
	echo ""
